<?php 
 ...
 ?>
  ...
  <section class="inner_page_breadcrumb" style="background-image: url('images/background/services.jpeg') !important; padding: 20px 0px 460px 0px;">
    <div class="container">
      <div class="row">
        <div class="col-xl-12">
          <div class="breadcrumb_content">
            <h2 class="breadcrumb_title">Services For Sale</h2>
            ...
            <div class="sidebar_widgets_wrapper">
              <div class="sidebar_advanced_search_widget">
                ...
                <ul class="sasw_list mb0">
                  ...
                  <li>
                    <h5 class="subtitle">Services Type</h5>
                  </li>
                  <li>
                  
                            <div class="checkbox-group">
  <?php
    $array = array('AutomobileMaintenance','Carwash/Detailing','AutomobileSpareParts','BoatMaintenance','BoatingSpareParts','PropellerRepair','Fiberglass/GelcoatRepair','BikeMaintenance','Painting','Island Tinting Services','Wheels and Tires','Stereo','Graphics/Signage/Flags','Tires','Fuelstations','Chromeplating/LaserCleaning/Powdercoating','Mobile_Tire_Repair','Towing_Services');
  ...
  ?>
                  ...
                  <li class="text-center"><a class="reset-filter" href="listings.php">Reset Filter</a></li>
                </ul>
                </form>
              </div>
            </div>
        ...
        <div class="col-lg-8 col-xl-9">
            ...
            if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                ...
                if(isset($_GET['type'])){
                    $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `listings` where is_active=1 and listing_type=2 and service_type='".$_GET['type']."' $str $str_price");
                }else{
            ...
            <div class="listing_filter_row db-lg">
              <div class="col-xl-5">
                <div class="page_control_shorting left_area tac-lg mb30-767 mt15">
                  <p>We found <span class="heading-color fw600"><?php echo $total_records; ?></span> Services available for you</p>
                </div>
              </div>
              <div class="col-xl-7">
          ...
          <div class="row">
              ...
              <?php
                   if(isset($_GET['type'])){
                        $select = "select * from listings where is_active=1 and listing_type=2 and  service_type='".$_GET['type']."'  $str $str_price order by id asc LIMIT $offset, $total_records_per_page";
                   }else{
