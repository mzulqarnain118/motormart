  ...
  <div class="col-lg-12">
    <div class="home1_advance_search_wrapper">
      ...
      <li class="list-inline-item">
        ...
        <li class="list-inline-item">
          <div class="select-boxes">
            <div class="car_brand">
              ...
              <select class="selectpicker" name='maker'  data-live-search="true" onchange="select_make_by_model_car(this.value,'car')">
        ...
        <li class="list-inline-item">
          <div class="select-boxes">
            <div class="car_models modelscar">
              ...
              <select class="form-control" name='model' style="background-color: transparent; border: 1px solid #eaeaea; border-radius: 8px; font-size:  13px;">
                <option value="0">Select Models</option>
                 <?php
                      $select = "select * from models where type='Cars' order by title asc ";
                       // $select = "select * from models order by title asc";
                        $q_run =  mysqli_query($con,$select);
                        if(mysqli_num_rows($q_run)>0){
                            while($data_cat =  mysqli_fetch_assoc($q_run)){
                                    echo "<option disabled='disabled' value='".$data_cat['id']."' class='model_car_".$data_cat['maker_id']." models_car' >".DBout($data_cat['title'])."</option>";
                                }
                        }
                      ?>
              </select>
