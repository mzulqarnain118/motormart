		...
		<div class="container-fluid">
			<div class="row">
              ...
              <div class="breadcrumb_content mb50">
                <h2 class="breadcrumb_title">Dealerships</h2>
                <p>Ready to jump back in!</p>
                <a href="add_dealership.php" class="btn btn-primary">Add Dealership</a>
              </div>
						</div>
					</div>
                  <div class="row">
                  ...
                  <div class="row">
                    <table class="table">
                      <thead>
                        <tr>
                          <th scope="col">#</th>
                          <th scope="col">Dealership Title</th>
                        ...
                        $second_last = $total_no_of_pages - 1; // total pages minus 1
                            ...
                            if(mysqli_num_rows($q_run)>0){
                                ...
                                <tr>
                                  ...
                                  <td><?php echo DBout($data['ratings']); ?></td>
                                  <td>
                                  <a href="edit_dealership.php?id=<?php echo $data['id']; ?>" class="btn  btn-primary">Edit</a>
                                    <a onclick="return confirm_delete()" href="delete.php?cmd=dealership&id=<?php echo $data['id']; ?>" class="btn  btn-danger">Delete</a>
                                  </td>
                                </tr>
                                <?php
                                }
