    ...
    <nav class="posr"> 
      <div class="container-fluid"> 
        ...
        <a href="../index.php" class="navbar_brand float-start dn-md">
          <img class="logo1 img-fluid" src="../images/site_logo.jpeg" style="width: 110px;" alt="header-logo2.png">
          <img class="logo2 img-fluid" src="../images/site_logo.jpeg" style="width: 110px;" alt="header-logo2.svg">
        </a>
        ...
        <ul id="respMenu" class="ace-responsive-menu menu_list_custom_code wa text-end" data-menu-style="horizontal">
          ...
          <li class="add_listing"><a href="add-listing.php">+ Add Listing</a></li>
          <li class="add_listing"><a href="add-accessory.php">+ Add Accessories</a></li>
          <li class="add_listing"><a href="add-service.php">+ Add Services</a></li>
