        ...
        <div class="col-xxl-10 offset-xxl-2 dashboard_grid_space">
              ...
              <div class="col-lg-12 mb50">
                <div class="breadcrumb_content">
                  <h2 class="breadcrumb_title">Edit Service</h2>
                ...
                <form class="contact_form" name="contact_form" action="controlling.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                        ...
                        <br />
                         <?php
                            ...
                            foreach($array as $key=>$val){
                                if($data['service_type']==$val){
                                    echo $val." <input type='radio' checked='checked' name='service_type' value='$val'/> &nbsp;";
                                }else{
                                    echo $val." <input type='radio' name='service_type' value='$val'/> &nbsp;";
                                }
                            }
                        ?>
                      </div>
                    ...
                    <div class="col-md-12" style="padding-top: 30px;">
                        <input type="submit" value="Save Service" class="btn btn-thm ad_flor_btn" />
                    </div>
                  </div>
