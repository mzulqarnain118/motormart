		...
		<div class="container-fluid">
			<div class="row">
              ...
              <div class="breadcrumb_content mb50">
                <h2 class="breadcrumb_title">Add Dealership</h2>
                        ...
                        <div class="ui_kit_input mb25">
                          <form method="post" action="controlling.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group p-1">
                              ...
                              <input type="text" class="form-control" required="" name="title"  placeholder="Dealership Title"/>
                            </div>
                            <div class="form-group p-1">
                             ...
                             <div class="form-group p-1">
                              ...
                              <input type="number" min="1" max="5" class="form-control" required="" name="ratings"  placeholder="Dealership Ratings"/>
                            </div>
                            <div class="form-group p-1">
