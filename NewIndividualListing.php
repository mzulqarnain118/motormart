...
.overview {
  ...
  padding: 37px;
     ...
     .mySlides {display: none; width: 100%; overflow: hidden;}
      .slide {width: 30%; float: left;margin-left:16px}
      .slide >img{
    height: 242px;}
...
<div class="external-div">
      ...
      <div class="mySlides">
        ...
        <div class="slide">
          <img src="<?php echo getServerURL(); ?>admin/listing_images/<?php echo $images_url[3]; ?>" alt="<?php echo $images_url[3]; ?>">
        </div>
      </div>
        <div class="mySlides">
          <div class="slide">
        ...
        <div class="slide">
          <img src="<?php echo getServerURL(); ?>admin/listing_images/<?php echo $images_url[4]; ?>" alt="<?php echo $images_url[4]; ?>">
        </div>
      </div>
         <div class="mySlides">
          <div class="slide">
        ...
        <div class="slide">
          <img src="<?php echo getServerURL(); ?>admin/listing_images/<?php echo $images_url[5]; ?>" alt="<?php echo $images_url[5]; ?>">
        </div>
      </div>
</div>
...
<section class="car-info">
  <div>
    ...
    width: 15px;" alt="Gasoline" width="15"
              height="15">
...
<section class="car-info">
  <div>
    <div>
      <img src="<?php echo getServerURL(); ?>admin/listing_images/<?php echo $images_url[10]; ?>" alt="About Picture" style="margin-right:0.5rem;    width: 556px;
    height: 408px;">
    </div>
    <div class="overview1">
...
<!-- <section class="review">
  <h1 class="italic-heading">Is the<?php echo $listingDataArray['model']; ?> <?php echo $listingDataArray['modelName']; ?> a Good Car?</h1>
  <p class="uppercase-paragraph">Read our expert review</p>
  <p><?php echo $listingDataArray['model']; ?>’s fresh take on the <?php echo $listingDataArray['modelName']; ?> formula adopts the more conventional
    front-wheel drive layout of its rivals, with the goal of improved interior space and practicality. Technology has
    also been expanded, with increased connectivity and expanded infotainment functionality. This, combined with a slick
    reinterpretation of BMW’s traditionally sporty handling, adds up to a compelling premium hatchback."</p>
</section> -->
