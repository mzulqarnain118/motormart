      ...
      <div class="col-lg-12">
        <div class="home1_advance_search_wrapper">
          ...
          <li class="list-inline-item">
            ...
            <li class="list-inline-item">
              <div class="select-boxes">
                <div class="car_brand" >
                  ...
                  <select class="selectpicker" name='maker'  data-live-search="true" onchange="select_make_by_model(this.value,'boat')">
            ...
            <li class="list-inline-item">
              <div class="select-boxes">
                <div class="car_models" id="model_boats">
                     ...
                     <?php
                          $select = "select * from models where type='Boats' order by title asc ";
                           // $select = "select * from models order by title asc";
                            ...
                            if(mysqli_num_rows($q_run)>0){
                                while($data_cat =  mysqli_fetch_assoc($q_run)){
                                        echo "<option value='".$data_cat['id']."' class='model_boat_".$data_cat['maker_id']." models_boat' disabled='disabled'>".DBout($data_cat['title'])."</option>";
                                    }
                            }
                          ?>
                  </select>
