<?php 
 ...
 ?>
  ...
  <section class="inner_page_breadcrumb" style="background-image: url('images/background/back_05.jpg') !important; padding: 20px 0px 460px 0px;">
    <div class="container">
      <div class="row">
        <div class="col-xl-12">
          <div class="breadcrumb_content">
            <h2 class="breadcrumb_title">Motorsports For Sale</h2>
          ...
          <div class="sidebar_widgets">
            <div class="sidebar_widgets_wrapper">
              <div class="sidebar_advanced_search_widget">
                ...
                <form method="get" action="motorsports_listings.php">
                <ul class="sasw_list mb0">
                  <li class="search_area">
                    <div class="form-group">
                      <input type="text" class="form-control" name="title" value="<?php if(isset($_GET['title'])){ echo $_GET['title']; } ?>" placeholder="Enter Keyword">
                        ...
                        <div class="dropdown bootstrap-select w100 show-tick">
                          ...
                          <select class="selectpicker  w100 show-tick" name='category_id' tabindex="-98"  data-live-search="true">
                                <option value="0">Select Category</option>
                                 <?php
                                  $inc_qry = mysqli_query($con,"select id,title from categories where cat_type='Boats'");
                    ...
                    <div class="search_option_two" id="model_car">                      
                      ...
                      <select class="form-control" id="model_car_drop" name='model' style="background-color: transparent; border: 1px solid #eaeaea; border-radius: 8px; font-size:  13px;">    
                                <option value="0">Select Models</option>
                                 <?php
                                      $select = "select * from models where type='Motorsports' order by title asc ";
                                       // $select = "select * from models order by title asc";
                                        $q_run =  mysqli_query($con,$select);
                                        if(mysqli_num_rows($q_run)>0){
                                            while($data_cat =  mysqli_fetch_assoc($q_run)){
        ...
        <div class="col-lg-8 col-xl-9">
            ...
            if (isset($_GET['page_no']) && $_GET['page_no']!="") {
              ...
              if (isset($_GET['min']) && $_GET['min']!="" &&  isset($_GET['max']) && $_GET['max']!="") {
                ...
                $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `listings` where is_active=1 and listing_type=0 and category_id IN($inc_motor) $str");
            ...
            <div class="listing_filter_row db-lg">
              <div class="col-xl-5">
                <div class="page_control_shorting left_area tac-lg mb30-767 mt15">
                  <p>We found <span class="heading-color fw600"><?php echo $total_records; ?></span> Vehicles available for you</p>
                </div>
              </div>
              <div class="col-xl-7">
          ...
          <div class="row">
              ...
              <?php
                  ...
                  $select = "select * from listings where is_active=1 and listing_type=0 $str and category_id IN($inc_motor) order by id asc LIMIT $offset, $total_records_per_page";
