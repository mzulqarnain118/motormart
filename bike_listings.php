<?php 
 ...
 ?>
  ...
  <section class="inner_page_breadcrumb" style="background-image: url('images/background/back_4.jpg') !important ;">
    <div class="container">
      <div class="row">
        <div class="col-xl-12">
          <div class="breadcrumb_content">
            <h2 class="breadcrumb_title">Bikes For Sale</h2>
                        ...
                        <div class="dropdown bootstrap-select w100 show-tick">
                          ...
                          <select class="selectpicker  w100 show-tick" name='category_id' tabindex="-98"  data-live-search="true">
                                <option value="0">Select Category</option>
                                 <?php
                                  $inc_qry = mysqli_query($con,"select id,title from categories where cat_type='Bikes'");
        ...
        <div class="col-lg-8 col-xl-9">
            ...
            if (isset($_GET['page_no']) && $_GET['page_no']!="") {
              ...
              if (isset($_GET['min']) && $_GET['min']!="" &&  isset($_GET['max']) && $_GET['max']!="") {
                ...
                $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `listings` where is_active=1  and listing_type=0  and category_id IN($bike_cats) $str");
            ...
            <div class="listing_filter_row db-lg">
              <div class="col-xl-5">
                <div class="page_control_shorting left_area tac-lg mb30-767 mt15">
                  <p>We found <span class="heading-color fw600"><?php echo $total_records; ?></span> Bikes available for you</p>
                </div>
              </div>
              <div class="col-xl-7">
          ...
          <div class="row">
              ...
              <?php
                  ...
                  $select = "select * from listings where is_active=1 and listing_type=0  $str and category_id IN($bike_cats) order by id asc LIMIT $offset, $total_records_per_page";
